...
document.writeln("                    <a   href=\'javascript:void(0)\'><i class=\'mdi mdi-palette\'></i>监控模块</a>");
...
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
document.writeln("                    <a  href=\'javascript:void(0)\'><i class=\'mdi mdi-format-align-justify\'></i>系统操作&设置</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a   href=\'/manualOperation\'>手动操作功能</a> </li>");
document.writeln("                        <li> <a   href=\'/parameterSetting\'>参数设定功能</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav \'>");
document.writeln("                    <a   href=\'javascript:void(0)\'><i class=\'mdi mdi-file-outline\'></i>压装程序设置</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a  href=\'/programMing\'>压装程序编写</a> </li>");
document.writeln("                        <li> <a  href=\'/parameterCompilation\'>产品压装参数编写</a> </li>");
document.writeln("                        <li> <a  href=\'/parameterStorage\'>产品压装参数存储</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
document.writeln("                    <a   href=\'javascript:void(0)\'><i class=\'mdi mdi-language-javascript\'></i> 压力位移曲线</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a  href=\'/curveAcquisition\'>曲线采集</a> </li>");
document.writeln("                        <li> <a  href=\'/curveStorage\'>曲线存储</a> </li>");
document.writeln("                        <li> <a  href=\'/dataQuery\'>历史数据查询</a> </li>");
document.writeln("                        <li> <a  href=\'/curveQuery\'>历史曲线查询</a> </li>");
document.writeln("                        <li> <a  href=\'/dataExport\'>历史数据导出</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
document.writeln("                    <a   href=\'javascript:void(0)\'><i class=\'mdi mdi-menu\'></i> 权限控制</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li  > <a  href=\'/accountManagement\'>管理员角色</a> </li>");
document.writeln("                        <li > <a  href=\'/OperatorRole\'>修改账户</a> </li>");
document.writeln("                        <li> <a  href=\'/createAnAccount\'>账号自主创设</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
document.writeln("                    <a   href=\'javascript:void(0)\'><i class=\'mdi mdi-menu\'></i> 报警</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a   href=\'/equipmentFaultAlarm\'>设备故障报警</a> </li>");
document.writeln("                        <li> <a   href=\'/callThePolice\'>报警信息历史查询</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
