...
document.writeln("    <link rel=\'icon\' href=\'favicon.ico\' type=\'image/ico\'>");
document.writeln("    <meta name=\'author\' content=\'yinqi\'>");
document.writeln("    <link href=\'css/bootstrap.min.css\' rel=\'stylesheet\'>");
document.writeln("    <link href=\'css/materialdesignicons.min.css\' rel=\'stylesheet\'>");
...
document.writeln("        <a target=\'_parent\' href=\'index.html\'><h2>HMI监控系统</h2></a>");
...
document.writeln("                    <a target=\'_parent\' href=\'javascript:void(0)\'><i class=\'mdi mdi-palette\'></i>监控模块</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/equipmentStatusMonitoring\'>设备状态监控</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/ioequipmentStatusMonitoring\'>设备IO状态监控</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/safetyMonitoring\'>安全监控操作</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/curveMonitoring\'>压装曲线监控</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
document.writeln("                    <a target=\'_parent\' href=\'javascript:void(0)\'><i class=\'mdi mdi-format-align-justify\'></i>系统操作&设置</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/manualOperation\'>手动操作功能</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/parameterSetting\'>参数设定功能</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav \'>");
document.writeln("                    <a target=\'_parent\' href=\'javascript:void(0)\'><i class=\'mdi mdi-file-outline\'></i>压装程序设置</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/programMing\'>压装程序编写</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/parameterCompilation\'>产品压装参数编写</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/parameterStorage\'>产品压装参数存储</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
document.writeln("                    <a target=\'_parent\' href=\'javascript:void(0)\'><i class=\'mdi mdi-language-javascript\'></i> 压力位移曲线</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/curveAcquisition\'>曲线采集</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/curveStorage\'>曲线存储</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/dataQuery\'>历史数据查询</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/curveQuery\'>历史曲线查询</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/dataExport\'>历史数据导出</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav active open\'>");
document.writeln("                    <a target=\'_parent\' href=\'javascript:void(0)\'><i class=\'mdi mdi-menu\'></i> 权限控制</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li class=\'active\'> <a target=\'_parent\' href=\'/accountManagement\'>管理员角色</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/OperatorRole\'>修改账户</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/createAnAccount\'>账号自主创设</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
document.writeln("                    <a target=\'_parent\' href=\'javascript:void(0)\'><i class=\'mdi mdi-menu\'></i> 报警</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/equipmentFaultAlarm\'>设备故障报警</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'/callThePolice\'>报警信息历史查询</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("                <li class=\'nav-item nav-item-has-subnav\'>");
document.writeln("                    <a target=\'_parent\' href=\'javascript:void(0)\'><i class=\'mdi mdi-menu\'></i> PLC对接</a>");
document.writeln("                    <ul class=\'nav nav-subnav\'>");
document.writeln("                        <li> <a target=\'_parent\' href=\'\'>多型号对接支持</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
document.writeln("            </ul>");
...
document.writeln("                    <a target=\'_parent\' href=\'javascript:void(0)\' data-toggle=\'dropdown\'>");
document.writeln("");
document.writeln("                        <span>我的<span class=\'caret\'></span></span>");
document.writeln("                    </a>");
document.writeln("                    <ul class=\'dropdown-menu dropdown-menu-right\'>");
document.writeln("                        <li> <a target=\'_parent\' href=\'lyear_pages_profile.html\'><i class=\'mdi mdi-account\'></i> 个人信息</a> </li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'lyear_pages_edit_pwd.html\'><i class=\'mdi mdi-lock-outline\'></i> 修改密码</a> </li>");
document.writeln("                        <li class=\'divider\'></li>");
document.writeln("                        <li> <a target=\'_parent\' href=\'lyear_pages_login.html\'><i class=\'mdi mdi-logout-variant\'></i> 退出登录</a> </li>");
document.writeln("                    </ul>");
document.writeln("                </li>");
...
document.writeln("<script type=\'text/javascript\' src=\'js/perfect-scrollbar.min.js\'></script>");
document.writeln("<script type=\'text/javascript\' src=\'js/main.min.js\'></script>");*/
