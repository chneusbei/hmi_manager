...
//    public static final String CURVE_TITLES = "ID, 压力曲线ID, 产品ID, 位置点序号, 位置, 压力, 速度, 压装时间点";
    ...
    public static final String[] TEMPERATURE_CURVE_TITLES_NEW = new String[]{"ID","批次号", "上位机名","上位机IP", "状态","数据所属日期", "低速轴偏心铜套温度检测1", "低速轴偏心铜套温度检测2",
            ...
            "拉杆两端铜套温度检测6","拉杆两端铜套温度检测7","拉杆两端铜套温度检测8","高速轴滚动轴承温度检测1","高速轴滚动轴承温度检测2",
            "高速轴滚动轴承温度检测1", "高速轴滚动轴承温度检测2", "左前三脚架偏心大铜套温度检测", "左后三脚架偏心大铜套温度检测", "右前三脚架偏心大铜套温度检测", "右后三脚架偏心大铜套温度检测",
    ...
    public enum PLC_TAG_GROUP {
        ...
        TEMPERATURE_NEW_DATA("temperatureNew", "温度数据查询"),
    ...
    public enum PLC_NAME_GROUP {
        ...
        PLC_4("A-4", "压机四"),
        PLC_5("A-5", "压机五"),
        PLC_WIRELESS_1("A-W1", "压机一无线"),
        PLC_WIRELESS_2("A-W2", "压机二无线"),
        PLC_WIRELESS_3("A-W3", "压机三无线"),
        PLC_WIRELESS_4("A-W4", "压机四无线"),
        PLC_WIRELESS_5("A-W5", "压机五无线");
        //枚举对象的变量
        private String code;
        private String value;
