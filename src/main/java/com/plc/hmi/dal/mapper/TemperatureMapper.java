...
public interface TemperatureMapper {
    ...
    @Results({
            ...
            @Result(column = "DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_1",property ="drawbarBothEndsCopperSleeveTemperature1"),
            @Result(column = "DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_2",property ="drawbarBothEndsCopperSleeveTemperature2"),
            @Result(column = "DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_3",property ="drawbarBothEndsCopperSleeveTemperature3"),
            @Result(column = "DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_4",property ="drawbarBothEndsCopperSleeveTemperature4"),
            @Result(column = "DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_5",property ="drawbarBothEndsCopperSleeveTemperature5"),
            @Result(column = "DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_6",property ="drawbarBothEndsCopperSleeveTemperature6"),
            @Result(column = "DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_7",property ="drawbarBothEndsCopperSleeveTemperature7"),
            @Result(column = "DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_8",property ="drawbarBothEndsCopperSleeveTemperature8"),
            ...
            @Result(column = "TEMPERATURE_WARNING_VALUE_A",property ="temperatureWarningValueA"),
            @Result(column = "LEFT_FRONT_ECCENTRIC_WHEEL",property ="leftFrontEccentricWheel"),
            @Result(column = "LEFT_REAR_ECCENTRIC_WHEEL",property ="leftRearEccentricWheel"),
            @Result(column = "RIGHT_FRONT_ECCENTRIC_WHEEL",property ="rightFrontEccentricWheel"),
            @Result(column = "RIGHT_REAR_ECCENTRIC_WHEEL",property ="rightRearEccentricWheel"),
            @Result(column = "LEFT_FRONT_CONNECTING_ROD",property ="leftFrontConnectingRod"),
            @Result(column = "LEFT_REAR_CONNECTING_ROD",property ="leftRearConnectingRod"),
            @Result(column = "RIGHT_FRONT_CONNECTING_ROD",property ="rightFrontConnectingRod"),
            @Result(column = "RIGHT_REAR_CONNECTING_ROD",property ="rightRearConnectingRod"),
            @Result(column = "RIGHT_FRONT_HIGH_SPEED_GEAR_BEARING_TEMPERATURE",property ="rightFrontHighSpeedGearBearingTemperature"),
            @Result(column = "RIGHT_REAR_HIGH_SPEED_GEAR_BEARING_TEMPERATURE",property ="rightRearHighSpeedGearBearingTemperature"),
            @Result(column = "LEFT_FRONT_HIGH_SPEED_GEAR_BEARING_TEMPERATURE",property ="leftFrontHighSpeedGearBearingTemperature"),
            @Result(column = "LEFT_REAR_HIGH_SPEED_GEAR_BEARING_TEMPERATURE",property ="leftRearHighSpeedGearBearingTemperature"),
            @Result(column = "RIGHT_FRONT_MIDDLE_GEAR_BEARING_TEMPERATURE",property ="rightFrontMiddleGearBearingTemperature"),
            @Result(column = "RIGHT_REAR_MIDDLE_GEAR_BEARING_TEMPERATURE",property ="rightRearMiddleGearBearingTemperature"),
            @Result(column = "LEFT_FRONT_MIDDLE_GEAR_BEARING_TEMPERATURE",property ="leftFrontMiddleGearBearingTemperature"),
            @Result(column = "LEFT_REAR_MIDDLE_GEAR_BEARING_TEMPERATURE",property ="leftRearMiddleGearBearingTemperature"),
            @Result(column = "MAIN_AXIS_GEAR_BEARING_TEMPERATURE_1",property ="mainAxisGearBearingTemperature1"),
            @Result(column = "MAIN_AXIS_GEAR_BEARING_TEMPERATURE_2",property ="mainAxisGearBearingTemperature2"),
            @Result(column = "MAIN_AXIS_GEAR_BEARING_TEMPERATURE_3",property ="mainAxisGearBearingTemperature3"),
            @Result(column = "MAIN_AXIS_GEAR_BEARING_TEMPERATURE_4",property ="mainAxisGearBearingTemperature4"),
            @Result(column = "MAIN_AXIS_GEAR_BEARING_TEMPERATURE_5",property ="mainAxisGearBearingTemperature5"),
            @Result(column = "MAIN_AXIS_GEAR_BEARING_TEMPERATURE_6",property ="mainAxisGearBearingTemperature6"),
            @Result(column = "MAIN_AXIS_GEAR_BEARING_TEMPERATURE_7",property ="mainAxisGearBearingTemperature7"),
            @Result(column = "MAIN_AXIS_GEAR_BEARING_TEMPERATURE_8",property ="mainAxisGearBearingTemperature8"),
            @Result(column = "CREATE_TIME",property ="createTime"),
    })
    List<TemperatureEntity> getTemperatureWithParam(@Param("startDate") String startDate, @Param("endDate") String endDate, @Param("plcName") String plcName, @Param("status") String status, @Param("isWireless") String isWireless, @Param("lineType") String lineType);


    @Insert({"INSERT INTO temperature(ID, BATCH_ID, PLC_IP, PLC_NAME, IS_WIRELESS, LINE_TYPE, HANDLE_DATE, STATUS, LOW_SPEED_AXIS_ECCENTRIC_COPPER_SLEEVE_TEMPERATURE_1, LOW_SPEED_AXIS_ECCENTRIC_COPPER_SLEEVE_TEMPERATURE_2, LOW_SPEED_AXIS_ECCENTRIC_COPPER_SLEEVE_TEMPERATURE_3, LOW_SPEED_AXIS_ECCENTRIC_COPPER_SLEEVE_TEMPERATURE_4, HIGH_SPEED_AXIS_ECCENTRIC_COPPER_SLEEVE_TEMPERATURE_1, HIGH_SPEED_AXIS_ECCENTRIC_COPPER_SLEEVE_TEMPERATURE_2, FLYWHEEL_SUPPORT_BIG_AXIS_TEMPERATURE_1, FLYWHEEL_SUPPORT_BIG_AXIS_TEMPERATURE_2, DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_1, DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_2, DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_3, DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_4, DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_5, DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_6, DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_7, DRAWBAR_BOTHENDS_COPPER_SLEEVE_TEMPERATURE_8, SMALL_BELT_WHEEL_SUPPORT_AXIS_TEMPERATURE_1, SMALL_BELT_WHEEL_SUPPORT_AXIS_TEMPERATURE_2, HIGH_SPEED_AXIS_ROLLING_BEARING_TEMPERATURE_1, HIGH_SPEED_AXIS_ROLLING_BEARING_TEMPERATURE_2, LEFT_FRONT_TRIPOD_ECCENTRIC_BIG_COPPER_SLEEVE_TEMPERATURE, LEFT_REAR_TRIPOD_ECCENTRIC_BIG_COPPER_SLEEVE_TEMPERATURE, RIGHT_FRONT_TRIPOD_ECCENTRIC_BIG_COPPER_SLEEVE_TEMPERATURE, RIGHT_REAR_TRIPOD_ECCENTRIC_BIG_COPPER_SLEEVE_TEMPERATURE, LEFT_FRONT_TRIPOD_BOTTOM_COPPER_SLEEVE_TEMPERATURE, LEFT_REAR_TRIPOD_BOTTOM_COPPER_SLEEVE_TEMPERATURE, RIGHT_FRONT_TRIPOD_BOTTOM_COPPER_SLEEVE_TEMPERATURE, RIGHT_REAR_TRIPOD_BOTTOM_COPPER_SLEEVE_TEMPERATURE, LEFT_FRONT_CONNECTING_ROD_BIG_COPPER_SLEEVE, LEFT_REAR_CONNECTING_ROD_BIG_COPPER_SLEEVE, RIGHT_FRONT_CONNECTING_ROD_BIG_COPPER_SLEEVE, RIGHT_REAR_CONNECTING_ROD_BIG_COPPER_SLEEVE, LEFT_FRONT_LOW_SPEED_AXIS_COPPER_SLEEVE, LEFT_REAR_LOW_SPEED_AXIS_COPPER_SLEEVE, RIGHT_FRONT_LOW_SPEED_AXIS_COPPER_SLEEVE, RIGHT_REAR_LOW_SPEED_AXIS_COPPER_SLEEVE, BACKUP_TEMPERATURE_0, BACKUP_TEMPERATURE_1, BACKUP_TEMPERATURE_2, BACKUP_TEMPERATURE_3, BACKUP_TEMPERATURE_4, BACKUP_TEMPERATURE_5, BACKUP_TEMPERATURE_6, BACKUP_TEMPERATURE_7, BACKUP_TEMPERATURE_8, BACKUP_TEMPERATURE_9, BACKUP_TEMPERATURE_10, BACKUP_TEMPERATURE_11, TEMPERATURE_WARNING_VALUE_1, TEMPERATURE_WARNING_VALUE_2, TEMPERATURE_WARNING_VALUE_A, LEFT_FRONT_ECCENTRIC_WHEEL, LEFT_REAR_ECCENTRIC_WHEEL, RIGHT_FRONT_ECCENTRIC_WHEEL, RIGHT_REAR_ECCENTRIC_WHEEL, LEFT_FRONT_CONNECTING_ROD, LEFT_REAR_CONNECTING_ROD, RIGHT_FRONT_CONNECTING_ROD, RIGHT_REAR_CONNECTING_ROD, RIGHT_FRONT_HIGH_SPEED_GEAR_BEARING_TEMPERATURE, RIGHT_REAR_HIGH_SPEED_GEAR_BEARING_TEMPERATURE, LEFT_FRONT_HIGH_SPEED_GEAR_BEARING_TEMPERATURE, LEFT_REAR_HIGH_SPEED_GEAR_BEARING_TEMPERATURE, RIGHT_FRONT_MIDDLE_GEAR_BEARING_TEMPERATURE, RIGHT_REAR_MIDDLE_GEAR_BEARING_TEMPERATURE, LEFT_FRONT_MIDDLE_GEAR_BEARING_TEMPERATURE, LEFT_REAR_MIDDLE_GEAR_BEARING_TEMPERATURE, MAIN_AXIS_GEAR_BEARING_TEMPERATURE_1, MAIN_AXIS_GEAR_BEARING_TEMPERATURE_2, MAIN_AXIS_GEAR_BEARING_TEMPERATURE_3, MAIN_AXIS_GEAR_BEARING_TEMPERATURE_4, MAIN_AXIS_GEAR_BEARING_TEMPERATURE_5, MAIN_AXIS_GEAR_BEARING_TEMPERATURE_6, MAIN_AXIS_GEAR_BEARING_TEMPERATURE_7, MAIN_AXIS_GEAR_BEARING_TEMPERATURE_8, CREATE_BY, UPDATE_BY, CREATE_TIME, UPDATE_TIME, IS_DELETED) values(null,#{entity.batchId},#{entity.plcIp},#{entity.plcName},#{entity.isWireless}, #{entity.lineType},#{entity.handleDate}, #{entity.status}, #{entity.lowSpeedAxisEccentricCopperSleeveTemperature1}, #{entity.lowSpeedAxisEccentricCopperSleeveTemperature2}, #{entity.lowSpeedAxisEccentricCopperSleeveTemperature3}, #{entity.lowSpeedAxisEccentricCopperSleeveTemperature4}, #{entity.highSpeedAxisEccentricCopperSleeveTemperature1}, #{entity.highSpeedAxisEccentricCopperSleeveTemperature2}, #{entity.flywheelSupportBigAxisTemperature1}, #{entity.flywheelSupportBigAxisTemperature2}, #{entity.drawbarBothEndsCopperSleeveTemperature1}, #{entity.drawbarBothEndsCopperSleeveTemperature2}, #{entity.drawbarBothEndsCopperSleeveTemperature3}, #{entity.drawbarBothEndsCopperSleeveTemperature4}, #{entity.drawbarBothEndsCopperSleeveTemperature5}, #{entity.drawbarBothEndsCopperSleeveTemperature6}, #{entity.drawbarBothEndsCopperSleeveTemperature7}, #{entity.drawbarBothEndsCopperSleeveTemperature8}, #{entity.smallBeltWheelSupportAxisTemperature1}, #{entity.smallBeltWheelSupportAxisTemperature2}, #{entity.highSpeedAxisRollingBearingTemperature1},#{entity.highSpeedAxisRollingBearingTemperature2}, #{entity.leftFrontTripodEccentricBigCopperSleeve}, #{entity.leftRearTripodEccentricBigCopperSleeve}, #{entity.rightFrontTripodEccentricBigCopperSleeve}, #{entity.rightRearTripodEccentricBigCopperSleeve},#{entity.leftFrontTripodBottomCopperSleeve}, #{entity.leftRearTripodBottomCopperSleeve}, #{entity.rightFrontTripodBottomCopperSleeve}, #{entity.rightRearTripodBottomCopperSleeve}, #{entity.leftFrontConnectingRodBigCopperSleeve},#{entity.leftRearConnectingRodBigCopperSleeve}, #{entity.rightFrontConnectingRodBigCopperSleeve}, #{entity.rightRearConnectingRodBigCopperSleeve}, #{entity.leftFrontLowSpeedAxisCopperSleeve}, #{entity.leftRearLowSpeedAxisCopperSleeve},#{entity.rightFrontLowSpeedAxisCopperSleeve}, #{entity.rightRearLowSpeedAxisCopperSleeve}, #{entity.backupTemperature0}, #{entity.backupTemperature1}, #{entity.backupTemperature2},#{entity.backupTemperature3}, #{entity.backupTemperature4}, #{entity.backupTemperature5}, #{entity.backupTemperature6}, #{entity.backupTemperature7},#{entity.backupTemperature8}, #{entity.backupTemperature9}, #{entity.backupTemperature10}, #{entity.backupTemperature11}, #{entity.temperatureWarningValue1},#{entity.temperatureWarningValue2},#{entity.temperatureWarningValueA}, #{entity.leftFrontEccentricWheel}, #{entity.leftRearEccentricWheel}, #{entity.rightFrontEccentricWheel}, #{entity.rightRearEccentricWheel}, #{entity.leftFrontConnectingRod}, #{entity.leftRearConnectingRod}, #{entity.rightFrontConnectingRod}, #{entity.rightRearConnectingRod},  #{entity.rightFrontHighSpeedGearBearingTemperature}, #{entity.rightRearHighSpeedGearBearingTemperature}, #{entity.leftFrontHighSpeedGearBearingTemperature}, #{entity.leftRearHighSpeedGearBearingTemperature}, #{entity.rightFrontMiddleGearBearingTemperature}, #{entity.rightRearMiddleGearBearingTemperature}, #{entity.leftFrontMiddleGearBearingTemperature}, #{entity.leftRearMiddleGearBearingTemperature}, #{entity.mainAxisGearBearingTemperature1}, #{entity.mainAxisGearBearingTemperature2}, #{entity.mainAxisGearBearingTemperature3}, #{entity.mainAxisGearBearingTemperature4}, #{entity.mainAxisGearBearingTemperature5}, #{entity.mainAxisGearBearingTemperature6}, #{entity.mainAxisGearBearingTemperature7}, #{entity.mainAxisGearBearingTemperature8},  #{entity.createBy}, #{entity.updateBy}, now(), now(), '0')"})
    void insert(@Param("entity") TemperatureEntity entity);

    @Delete({"DELETE FROM temperature WHERE  HANDLE_DATE <= date_format(DATE_SUB(now(), INTERVAL #{months} MONTH),'%Y%m%d')"})
    void deleteHistoryData(int months);

    @Select({"select max(id) maxId from temperature"})
    long getMaxId();

    @Select({"<script>",
            "select * from temperature where id > #{maxId}",
            "</script>" })
    @Results({
            @Result(id=true,column = "ID",property = "id" ),
            @Result(column = "BATCH_ID",property ="batchId"),
    ...
    List<TemperatureEntity> getTemperatureWithMaxId(@Param("maxId") long maxId);
