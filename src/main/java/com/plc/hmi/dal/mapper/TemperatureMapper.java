...
public interface TemperatureMapper {
    ...
    List<TemperatureEntity> getTemperatureWithParam(@Param("startDate") String startDate, @Param("endDate") String endDate, @Param("plcName") String plcName, @Param("status") String status, @Param("isWireless") String isWireless, @Param("lineType") String lineType, @Param("limit") int limit);
