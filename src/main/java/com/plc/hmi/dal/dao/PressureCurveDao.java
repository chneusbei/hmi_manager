...
//        }
    ...
    public List<PressureCurveEntity> getPressureCurveWithDate(String recordId, int pressureHeadNo) {
        return pressureCurveMapper.getCurveDataWithDate(recordId, pressureHeadNo);
    }
//
