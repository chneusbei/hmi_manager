...
//                isOk = isCurveSuccess(errandResultList);
    ...
    private boolean setCurveResult(ErrandResultEntity errandResultEntity, List<PressureCurveEntity> entityList) {
        ...
        if(errandResultEntity.getErrandType() == 0) {
            ...
            if (maxPress.compareTo(errandResultEntity.getPressMax()) < 0
                    && maxPress.compareTo(errandResultEntity.getPressMin()) > 0) {
                return true;
            } else {
                return false;
            }
            ...
            if (subEntityList.size() > 0
                    ...
                    && minPosition.compareTo(errandResultEntity.getPositionMin()) < 0
