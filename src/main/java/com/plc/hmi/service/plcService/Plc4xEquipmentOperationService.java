...
@Service
@Component
public class Plc4xEquipmentOperationService extends Plc4xBaseService{
    public static final String tagGroup = HmiConstants.PLC_TAG_GROUP.EQUIPMENT_OPERATION.getCode();
    /**
     *  获取设备状态
     *  频率是每秒钟一次
