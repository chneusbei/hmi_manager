...
@Service
@Component
public class Plc4xServoOperationService extends Plc4xBaseService{
    public static final String tagGroup = HmiConstants.PLC_TAG_GROUP.SERVO_OPERATION.getCode();
    /**
     *  获取设备状态
     *  频率是每秒钟一次
