...
//            TemperatureMap.put(plcConfigEntity.getPlcName(),temperatureEntityList);
            ...
            //入库温度报警信息
            List<TemperatureAlarmEntity> temperatureAlarmList = this.getTemperatureAlarmList(temperatureEntityList, lineType);
...
//            System.out.println("Plc4xTemperatureDataService.temperatureList2DB: temperatureEntityList is null");
     ...
     * @return
     */
    private List<TemperatureAlarmEntity> getTemperatureAlarmList(List<List<TemperatureEntity>> temperatureEntityList, String lineType) {
        ...
        for(List<TemperatureEntity> list : temperatureEntityList) {
            for (TemperatureEntity temperatureEntity : list ) {
                ...
                if (HmiConstants.LINE_TYPE.LINE_TYPE_B.getCode().equalsIgnoreCase(lineType)) {
                    ...
                    BigDecimal temperatureWarningValue2 = temperatureEntity.getTemperatureWarningValue2();
                    if (HmiUtils.isBigThanOrEquals(temperatureEntity.getLowSpeedAxisEccentricCopperSleeveTemperature1(), temperatureWarningValue1, temperatureWarningValue2)) {
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "低速轴偏心铜套温度检测1", temperatureEntity.getLowSpeedAxisEccentricCopperSleeveTemperature1(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "低速轴偏心铜套温度检测2", temperatureEntity.getLowSpeedAxisEccentricCopperSleeveTemperature2(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "低速轴偏心铜套温度检测3", temperatureEntity.getLowSpeedAxisEccentricCopperSleeveTemperature3(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "低速轴偏心铜套温度检测4", temperatureEntity.getLowSpeedAxisEccentricCopperSleeveTemperature4(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "高速轴偏心铜套温度检测1", temperatureEntity.getHighSpeedAxisEccentricCopperSleeveTemperature1(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "高速轴偏心铜套温度检测2", temperatureEntity.getHighSpeedAxisEccentricCopperSleeveTemperature2(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "飞轮支撑大轴承温度检测1", temperatureEntity.getFlywheelSupportBigAxisTemperature1(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "飞轮支撑大轴承温度检测2", temperatureEntity.getFlywheelSupportBigAxisTemperature2(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "拉杆两端铜套温度检测1", temperatureEntity.getDrawbarBothEndsCopperSleeveTemperature1(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "拉杆两端铜套温度检测2", temperatureEntity.getDrawbarBothEndsCopperSleeveTemperature2(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "拉杆两端铜套温度检测3", temperatureEntity.getDrawbarBothEndsCopperSleeveTemperature3(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "拉杆两端铜套温度检测4", temperatureEntity.getDrawbarBothEndsCopperSleeveTemperature4(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "拉杆两端铜套温度检测5", temperatureEntity.getDrawbarBothEndsCopperSleeveTemperature5(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "拉杆两端铜套温度检测6", temperatureEntity.getDrawbarBothEndsCopperSleeveTemperature6(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "拉杆两端铜套温度检测7", temperatureEntity.getDrawbarBothEndsCopperSleeveTemperature7(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "拉杆两端铜套温度检测8", temperatureEntity.getDrawbarBothEndsCopperSleeveTemperature8(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "小皮带轮支持轴承温度检测1", temperatureEntity.getSmallBeltWheelSupportAxisTemperature1(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "小皮带轮支持轴承温度检测2", temperatureEntity.getSmallBeltWheelSupportAxisTemperature2(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "高速轴滚动轴承温度检测1", temperatureEntity.getHighSpeedAxisRollingBearingTemperature1(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "高速轴滚动轴承温度检测2", temperatureEntity.getHighSpeedAxisRollingBearingTemperature2(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左前三脚架偏心大铜套温度检测", temperatureEntity.getLeftFrontTripodEccentricBigCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左后三脚架偏心大铜套温度检测", temperatureEntity.getLeftRearTripodEccentricBigCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右前三脚架偏心大铜套温度检测", temperatureEntity.getRightFrontTripodEccentricBigCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右后三脚架偏心大铜套温度检测", temperatureEntity.getRightRearTripodEccentricBigCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左前三脚架下端铜套温度检测", temperatureEntity.getLeftFrontTripodBottomCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左后三脚架下端铜套温度检测", temperatureEntity.getLeftRearTripodBottomCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右前三脚架下端铜套温度检测", temperatureEntity.getRightFrontTripodBottomCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右后三脚架下端铜套温度检测", temperatureEntity.getRightRearTripodBottomCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左前连杆大铜套", temperatureEntity.getLeftFrontConnectingRodBigCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左后连杆大铜套", temperatureEntity.getLeftRearConnectingRodBigCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右前连杆大铜套", temperatureEntity.getRightFrontConnectingRodBigCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右后连杆大铜套", temperatureEntity.getRightRearConnectingRodBigCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左前低速轴铜套", temperatureEntity.getLeftFrontLowSpeedAxisCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左后低速轴铜套", temperatureEntity.getLeftRearLowSpeedAxisCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右前低速轴铜套", temperatureEntity.getRightFrontLowSpeedAxisCopperSleeve(), temperatureWarningValue1));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右后低速轴铜套", temperatureEntity.getRightRearLowSpeedAxisCopperSleeve(), temperatureWarningValue1));
                    }
                } else {
                    //A 线
                    ...
                    if (HmiUtils.isBigThanOrEquals(temperatureEntity.getLeftFrontEccentricWheel(), temperatureWarningValueA, temperatureWarningValueA)) {
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "偏心轮左前", temperatureEntity.getLeftFrontEccentricWheel(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "偏心轮左后", temperatureEntity.getLeftRearEccentricWheel(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "偏心轮右前", temperatureEntity.getRightFrontEccentricWheel(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "偏心轮右后", temperatureEntity.getRightRearEccentricWheel(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "连杆左前", temperatureEntity.getLeftFrontConnectingRod(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "连杆左后", temperatureEntity.getLeftRearConnectingRod(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "连杆右前", temperatureEntity.getRightFrontConnectingRod(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "连杆右后", temperatureEntity.getRightRearConnectingRod(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右高速齿轮轴承(前)温度", temperatureEntity.getRightFrontHighSpeedGearBearingTemperature(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右高速齿轮轴承(后)温度", temperatureEntity.getRightRearHighSpeedGearBearingTemperature(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左高速齿轮轴承(前)温度", temperatureEntity.getLeftFrontHighSpeedGearBearingTemperature(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左高速齿轮轴承(后)温度", temperatureEntity.getLeftRearHighSpeedGearBearingTemperature(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右中间齿轮轴承(前)温度", temperatureEntity.getRightFrontMiddleGearBearingTemperature(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "右中间齿轮轴承(后)温度", temperatureEntity.getRightRearMiddleGearBearingTemperature(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左中间齿轮轴承(前)温度", temperatureEntity.getLeftFrontMiddleGearBearingTemperature(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "左中间齿轮轴承(后)温度", temperatureEntity.getLeftRearMiddleGearBearingTemperature(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "主轴齿轮轴承1温度", temperatureEntity.getMainAxisGearBearingTemperature1(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "主轴齿轮轴承2温度", temperatureEntity.getMainAxisGearBearingTemperature2(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "主轴齿轮轴承3温度", temperatureEntity.getMainAxisGearBearingTemperature3(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "主轴齿轮轴承4温度", temperatureEntity.getMainAxisGearBearingTemperature4(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "主轴齿轮轴承5温度", temperatureEntity.getMainAxisGearBearingTemperature5(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "主轴齿轮轴承6温度", temperatureEntity.getMainAxisGearBearingTemperature6(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "主轴齿轮轴承7温度", temperatureEntity.getMainAxisGearBearingTemperature7(), temperatureWarningValueA));
                        ...
                        temperatureAlarmList.add(new TemperatureAlarmEntity(temperatureEntity.getId(), temperatureEntity.getHandleDate(), lineType, "主轴齿轮轴承8温度", temperatureEntity.getMainAxisGearBearingTemperature8(), temperatureWarningValueA));
                    }
                }
            }
        }
