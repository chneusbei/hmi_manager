...
@Service
@Component
public class Plc4xEquipmentAlarmService extends Plc4xBaseService{
    public static final String tagGroup = HmiConstants.PLC_TAG_GROUP.EQUIPMENT_ALARM.getCode();
    /**
     *  获取设备状态
     *  频率是每秒钟一次
